package io.github.rosestack.spring.boot.encrypt.health;
...
public class CryptoHealthIndicator implements HealthIndicator {
    ...
    private void checkBasicFunctionality(Health.Builder builder) {
        ...
        try {
            ...
            // 测试 AES 加密解密
            String encrypted = EncryptUtils.encrypt(TEST_PLAIN_TEXT, EncryptType.AES, properties.getSecretKey());
            String decrypted = EncryptUtils.decrypt(encrypted, EncryptType.AES, properties.getSecretKey());
