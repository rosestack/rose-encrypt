...
class DefaultFieldEncryptorTest {
    ...
    void testShortSecretKeyThrowsException() {
        ...
        assertThrows(EncryptException.class, () -> shortKeyEncryptor.encrypt(TEST_PLAIN_TEXT, EncryptType.AES));
    }
    ...
    void testEmptySecretKeyThrowsException() {
        ...
        assertThrows(EncryptException.class, () -> emptyKeyEncryptor.encrypt(TEST_PLAIN_TEXT, EncryptType.AES));

        DefaultFieldEncryptor nullKeyEncryptor = new DefaultFieldEncryptor(null, true);

        assertThrows(EncryptException.class, () -> nullKeyEncryptor.encrypt(TEST_PLAIN_TEXT, EncryptType.AES));
    }
    ...
    void testFailSafeMode() {
        ...
        assertThrows(EncryptException.class, () -> encryptor.decrypt(invalidCipherText, EncryptType.AES));
    }
    ...
    void testPerformanceStatsIntegration() {
        ...
        var stats = EncryptMonitorManager.getInstance().getPerformanceStats();
        assertNotNull(stats);
