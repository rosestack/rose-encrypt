...
class EncryptorPerformanceTest {
    ...
    void testAESEncryptionPerformance() {
        ...
        System.out.printf("AES性能测试结果：%d次操作耗时%dms，平均%.2f操作/秒%n", iterations * 2, durationMs, operationsPerSecond);
    ...
    void testPerformanceComparisonBetweenAlgorithms() {
        ...
        for (EncryptType algorithm : algorithms) {
            ...
            System.out.printf(
                    "%s算法：%d次操作耗时%dms，平均%.2f操作/秒%n", algorithm, iterations * 2, durationMs, operationsPerSecond);
        }
    }
