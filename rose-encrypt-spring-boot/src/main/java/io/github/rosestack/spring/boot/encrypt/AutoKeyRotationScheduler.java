...
import io.github.rosestack.encrypt.rotation.KeyRotationProperties;
import io.github.rosestack.encrypt.rotation.KeySpec;
...
public class AutoKeyRotationScheduler {
    ...
    private boolean shouldRotateKey(KeySpec currentKey) {
        ...
        int rotationDays = properties.getAutoRotationDays();
    ...
    private void cleanupExpiredKeys() {
        try {
            ...
            int retentionDays = properties.getKeyRetentionDays();
    ...
    public static class RotationStatus {
        ...
        public static class RotationStatusBuilder {
            ...
            public RotationStatusBuilder status(String status) {
                this.status = status;
                return this;
            }

            public RotationStatusBuilder currentVersion(String currentVersion) {
                this.currentVersion = currentVersion;
                return this;
            }

            public RotationStatusBuilder activeTime(LocalDateTime activeTime) {
                this.activeTime = activeTime;
                return this;
            }

            public RotationStatusBuilder nextRotationTime(LocalDateTime nextRotationTime) {
                this.nextRotationTime = nextRotationTime;
                return this;
            }

            public RotationStatusBuilder needsRotation(boolean needsRotation) {
                this.needsRotation = needsRotation;
                return this;
            }

            public RotationStatusBuilder message(String message) {
